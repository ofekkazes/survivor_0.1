...
public class YarnLibgdx extends ApplicationAdapter {
	...
	public void create() {
		...
		ship_textures.put("happy", new Texture(Gdx.files.internal("images/characters/happy.png")));
		ship_textures.put("neutral", new Texture(Gdx.files.internal("images/characters/neutral.png")));

		ship_face = ship_textures.get("neutral");

		sally_textures = new ObjectMap<String, Texture>();
		sally_textures.put("default", new Texture(Gdx.files.internal("images/characters/sally.png")));
		sally_textures.put("angry", new Texture(Gdx.files.internal("images/characters/sally_angry.png")));
		sally_textures.put("talk", new Texture(Gdx.files.internal("images/characters/sally_talk.png")));
