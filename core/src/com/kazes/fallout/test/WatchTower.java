...
public class WatchTower extends Group {
    ...
    public WatchTower(float xPos, float yPos, String name, World world) {
        ImageEx tower = new ImageEx(Assets.getAsset(Assets.Images.HOUSE1, Texture.class), xPos, yPos, world, BodyDef.BodyType.StaticBody, CollisionCategory.DECORATION, CollisionCategory.DECORATION_COLLIDER);
